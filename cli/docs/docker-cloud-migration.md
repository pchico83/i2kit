...
- a security group for inter service communication in the same project. It can be also used to configure access to AWS resources, such as RDS databases, from services belonging to a project
- a keypair
