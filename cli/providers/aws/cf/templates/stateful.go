...
func stateful(t *gocf.Template, s *service.Service, e *environment.Environment, encodedCompose string) error {
...
func securityGroup(t *gocf.Template, s *service.Service, e *environment.Environment) {
